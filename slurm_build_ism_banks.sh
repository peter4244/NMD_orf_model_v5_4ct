...
#   chunk  4,096   4,315 substitutions/s
#   chunk 16,384   4,654 substitutions/s   <- used here, +8% for 1.22 GB of 32
# at ~7,500 substitutions per transcript that is ~2.2 h for 5,000, inside the
# 8-hour partition limit with headroom. The earlier 856/s was a 3-transcript build
# where CUDA warmup was 50 of 53 seconds, and is not the rate.
#
