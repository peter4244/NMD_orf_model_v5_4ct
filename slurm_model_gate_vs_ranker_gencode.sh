...
#SBATCH --job-name=md_gate
#SBATCH --output=results_ism_v6/model_gate_vs_ranker_gencode_%j.log
...
echo "=== code (sha256) ==="
sha256sum analysis_plans/model_gate_vs_ranker_gencode.py
echo ""
$PY analysis_plans/model_gate_vs_ranker_gencode.py
echo "=== exit: $? ==="
