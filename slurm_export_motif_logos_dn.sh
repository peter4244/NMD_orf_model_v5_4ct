...
#SBATCH --job-name=export_motif_logos_dn
#SBATCH --output=results_deposit_h5_2026-08-04/export_motif_logos_dn_%j.log

# DEPOSIT-NATIVE port of drivers/slurm_export_joint_motif_logos.sh, 2026-08-12.
