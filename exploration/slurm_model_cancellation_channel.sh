...
#SBATCH --job-name=md_canc
#SBATCH --output=results_ism_v6/model_cancellation_channel_%j.log
...
echo ""
$PY analysis_plans/model_cancellation_channel.py --bank results_ism_v6/bank_interp_s100.h5
echo "=== exit: $? ==="
